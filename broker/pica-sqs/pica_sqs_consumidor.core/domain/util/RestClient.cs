...
namespace Util
{
    ...
    {
        public async Task<T> MakeRequest<T>(string requestUrlApi, string JSONobject, string JSONmethod, string JSONContentType, int msTimeOut,
